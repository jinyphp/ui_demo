            ...
            <x-container-fluid>
                        ...
                        <div class="w-100">
                            <x-row>
                                <x-col class="col-sm-6">
                                    @widget("uidemo::widgets.stats.summary_sales",[
                                        'title' => 'Sales',
                                    ...
                                    @include("uidemo::widgets.stats.summary_visitors")
                                </x-col>

                                <x-col class="col-sm-6">
                                    @include("uidemo::widgets.stats.summary_earnings")
                                    @include("uidemo::widgets.stats.summary_orders")
                                </x-col>
                            </x-row>
                ...
                <x-row>
                    <div class="col-12 col-lg-8 col-xxl-9 d-flex">
                        @include("uidemo::widgets.projects")
                    </div>
                    <div class="col-12 col-lg-4 col-xxl-3 d-flex">
                        @include("uidemo::widgets.monthly")
                    </div>
                </x-row>
