            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="card flex-fill w-100">
                        ...
                        <div class="card-body">
                            @include("uidemo::charts.chartjs.line")
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @include("uidemo::charts.chartjs.bar")
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @include("uidemo::charts.chartjs.doughnut")
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @include("uidemo::charts.chartjs.pie")
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @include("uidemo::charts.chartjs.rader")
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @include("uidemo::charts.chartjs.polar")
                        </div>
                    </div>
                </div>
            </div>
