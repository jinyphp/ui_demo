                        ...
                        <div class="card-body">
                            <x-navtab class="nav-bordered mb-3">
                                <x-navtab-item class="show active" >
                                    ...
                                    {{-- preview 코드를 삽입합니다. --}}
                                    <div class="mb-3">
                                        @include("uidemo::ui.alert.default")
                                    </div>
                        ...
                        <div class="card-body">
                            <x-navtab class="nav-bordered mb-3">
                                <x-navtab-item class="show active" >
                                    ...
                                    {{-- preview 코드를 삽입합니다. --}}
                                    <div class="mb-3">
                                        @include("uidemo::ui.alert.outline")
                                    </div>
                        ...
                        <div class="card-body">
                            <x-navtab class="nav-bordered mb-3">
                                <x-navtab-item class="show active" >
                                    ...
                                    {{-- preview 코드를 삽입합니다. --}}
                                    @include("uidemo::ui.alert.message")
                        ...
                        <div class="card-body">
                            <x-navtab class="nav-bordered mb-3">
                                <x-navtab-item class="show active" >
                                    ...
                                    {{-- preview 코드를 삽입합니다. --}}
                                    @include("uidemo::ui.alert.confirm")
