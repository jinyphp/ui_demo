            ...
            <x-row>
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body>
                            ...
                            {{-- widget --}}
                            @include("uidemo::widgets.preview",
                                ['code'=>"uidemo::toggle.dropdown.button"]
                            )
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body >
                            {{-- widget --}}
                            @include("uidemo::widgets.preview",
                                ['code'=>"uidemo::toggle.dropdown.link"]
                            )
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body>
                            @include("uidemo::toggle.dropdown.alram")
                        </x-card-body>
                    </x-card>
                </x-col-6>
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body class="flex flex-row gap-2">
                            @include("uidemo::toggle.dropdown.group")
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body class="flex flex-row gap-2">
                            @include("uidemo::toggle.dropdown.split")
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body class="flex flex-row gap-2">
                            @include("uidemo::toggle.dropdown.size")
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body>
                            @include("uidemo::toggle.dropdown.dark")
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body>
                            @include("uidemo::toggle.dropdown.nav")
                        </x-card-body>
                    </x-card>
                </x-col-6>
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body>
                            @include("uidemo::toggle.dropdown.direction")
                        ...
                        <x-card-body>
                            <div class="row mb-3">
                                <div class="col-12 col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                                    ...
                                    @include("uidemo::toggle.dropdown.menu-basic")
                                </div>
                                <div class="col-12 col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                                    <p class="mb-0">Active:</p>
                                    @include("uidemo::toggle.dropdown.menu-active")
                                </div>
                                <div class="col-12 col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                                    <p class="mb-0">Disabled:</p>
                                    @include("uidemo::toggle.dropdown.menu-disable")
                                </div>
                        ...
                        <x-card-body>
                            <div class="row mb-3">
                                <div class="col-12 col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                                    ...
                                    @include("uidemo::toggle.dropdown.menu-header")
                                </div>
                                <div class="col-12 col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                                    <p class="mb-0">Dividers:</p>
                                    @include("uidemo::toggle.dropdown.menu-devider")

                                </div>
                                <div class="col-12 col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                                    <p class="mb-0">Text:</p>
                                    @include("uidemo::toggle.dropdown.menu-text")
                                </div>
                            </div>
                        </x-card-body>
                    </x-card>
