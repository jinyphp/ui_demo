<div class="mb-3">
    <x-jinyui::alert.confirm class="alert-success">
        <h4 class="alert-heading">Well done!</h4>
            ...
            <hr>
    </x-jinyui::alert.confirm>                                    
</div>

<div class="mb-3">
    <x-jinyui::alert.confirm class="alert-primary">
        <h4 class="alert-heading">Well done!</h4>
            <p>Aww yeah, you successfully read this important alert message. This example text is going to run a bit longer
                so that you can see how spacing within an alert works with this kind of content.</p>
            <hr>
...
<div class="mb-3">
    <x-jinyui::alert.confirm-outline class="alert-primary">
        <h4 class="alert-heading">Well done!</h4>
            <p>Aww yeah, you successfully read this important alert message. This example text is going to run a bit longer
                so that you can see how spacing within an alert works with this kind of content.</p>
            <hr>
    </x-jinyui::alert.confirm-outline>                                    
</div>