            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <x-card>
                        ...
                        <div class="card-body">
                            @include("uidemo::charts.apex.line")
                        </div>
                    </x-card>
                ...
                <div class="col-12 col-lg-6">
                    <x-card>
                        ...
                        <div class="card-body">
                            @include("uidemo::charts.apex.area")
                        </div>
                    </x-card>
                ...
                <div class="col-12 col-lg-6">
                    <x-card>
                        ...
                        <div class="card-body">
                            @include("uidemo::charts.apex.bar")
                        </div>
                    </x-card>
                ...
                <div class="col-12 col-lg-6">
                    <x-card>
                        ...
                        <div class="card-body">
                            @include("uidemo::charts.apex.column")
                        </div>
                    </x-card>
                ...
                <div class="col-12 col-lg-6">
                    <x-card>
                        ...
                        <div class="card-body text-center">
                            @include("uidemo::charts.apex.pie")
                        </div>
                    </x-card>
                ...
                <div class="col-12 col-lg-6">
                    <x-card>
                        ...
                        <div class="card-body">
                            @include("uidemo::charts.apex.heatmap")
                        </div>
                    </x-card>
                ...
                <div class="col-12 col-lg-6">
                    <x-card>
                        ...
                        <div class="card-body">
                            @include("uidemo::charts.apex.mixed")
                        </div>
                    </x-card>
                ...
                <div class="col-12 col-lg-6">
                    <x-card>
                        ...
                        <div class="card-body">
                            @include("uidemo::charts.apex.candle")
                        </div>
                    </x-card>
