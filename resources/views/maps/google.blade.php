            ...
            <x-row>
                <x-col-6>
                    <x-card>
                        ...
                        <div class="card-body">
                            @include("uidemo::maps.google.default")
                        </div>
                    </x-card>
                </x-col-6>
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <div class="card-body">
                            @include("uidemo::maps.google.hybrid")
                        </div>
                    </x-card>
                </x-col-6>
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <div class="card-body">
                            @include("uidemo::maps.google.light")
                        </div>
                    </x-card>
                </x-col-6>
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <div class="card-body">
                            @include("uidemo::maps.google.dark")
                        </div>
                    </x-card>
                </x-col-6>
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <div class="card-body" jstcache="0">
                            @include("uidemo::maps.google.streetview")
                        </div>
                    </x-card>
                </x-col-6>
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <div class="card-body">
                            @include("uidemo::maps.google.markers")
                        </div>
                    </x-card>
                </x-col-6>
